# Contributing to descend

Thanks for your interest. descend is training infrastructure primitives: optimizers, LR schedules, gradient clipping, early stopping.
...
- Commit messages: `descend: short lowercase description`. One commit per logical change.
